...
print(f'Combining HDF5s...')
print(f'from {pathnames[0]}...')
print(f'to {pathnames[len(pathnames)]}...')

dest_path = input('Enter path of new combined HDF5:')
print("Save path is: " + dest_path)
...
with h5py.File(dest, 'w') as dest_hdf5:
...
print('Finished writing combined HDF5...')
